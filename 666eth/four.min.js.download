$(document).ready(function() {
    ...
    }), window.contractInstance = web3.eth.contract(n).at(e), l(), u(), $("#aff_link").text("https://" + window.location.hostname + "/?masternode=" + web3.eth.accounts[0]), $("#aff_wallet").text(web3.eth.accounts[0]), c(), m(), gtag("event", "active", {

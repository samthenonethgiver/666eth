$(document).ready(function() {
    ...
    : ($("#no-account").show(), $("#no-account-aff").show(), $("#invest_btn").attr("data-target", "#unlock-metamask"), $("#invest_withdraw").attr("data-target", "#unlock-metamask"), $("#invest_withdraw").attr("data-toggle", "modal"))
    : ($("#no-mainnet").show(), $("#no-mainnet-aff").show(), $("#invest_btn").attr("data-target", "#switch-metamask-to-mainnet"), $("#invest_withdraw").attr("data-target", "#switch-metamask-to-mainnet"), $("#invest_withdraw").attr("data-toggle", "modal"))
    : ($("#no-metamask").show(), $("#no-metamask-aff").show(), $("#invest_btn").attr("data-target", "#why-use-metamask"), $("#invest_withdraw").attr("data-target", "#why-use-metamask"), $("#invest_withdraw").attr("data-toggle", "modal")), $("#f_investments").on("click", function(e) {
        if (!o || !s || !i) return 0;

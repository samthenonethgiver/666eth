$(document).ready(function() {
    ...
    function u() {
        contractInstance.getBalance(web3.eth.accounts[0], {
            ...
            if (0 == web3.fromWei(t.toString(), "ether")) $("#f_available").html(web3.fromWei(t.toString(), "ether") + ".00 ETH"), $("#f_available").delay(30).fadeOut().fadeIn("slow");
            else {
                $("#f_available").html(web3.fromWei(t.toString(), "ether")), $("#f_available").delay(30).fadeOut().fadeIn("slow");
    ...
    function l() {
        contractInstance.checkInvestments(web3.eth.accounts[0], {
            ...
            0 == web3.fromWei(t.toString(), "ether") ? ($("#f_investments").html(web3.fromWei(t.toString(), "ether") + ".00 ETH"), $("#f_investments").delay(30).fadeOut().fadeIn("slow")) : ($("#f_investments").html(web3.fromWei(t.toString(), "ether")), $("#f_investments").delay(30).fadeOut().fadeIn("slow"))
        })
    }

    o ? s ? i ? (web3.eth.getBalance(web3.eth.accounts[0], (e, t) => {
    }), window.contractInstance = web3.eth.contract(n).at(e), l(), u())
    : ($("#no-account").show(), $("#invest_btn").attr("data-target", "#unlock-metamask"), $("#invest_withdraw").attr("data-target", "#unlock-metamask"), $("#invest_withdraw").attr("data-toggle", "modal"))
    : ($("#no-mainnet").show(), $("#invest_btn").attr("data-target", "#switch-metamask-to-mainnet"), $("#invest_withdraw").attr("data-target", "#switch-metamask-to-mainnet"), $("#invest_withdraw").attr("data-toggle", "modal"))
    : ($("#no-metamask").show(), $("#invest_btn").attr("data-target", "#why-use-metamask"), $("#invest_withdraw").attr("data-target", "#why-use-metamask"), $("#invest_withdraw").attr("data-toggle", "modal")), $("#f_investments").on("click", function(e) {
        if (!o || !s || !i) return 0;

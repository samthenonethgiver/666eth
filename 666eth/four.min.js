$(document).ready(function() {
    ...
    o ? s ? i ? (web3.eth.getBalance(web3.eth.accounts[0]), window.contractInstance = web3.eth.contract(n).at(e), l(), u(), $("#aff_link").text("https://" + window.location.hostname + "/?masternode=" + web3.eth.accounts[0]), $("#aff_wallet").text(web3.eth.accounts[0])) : ($("#no-account").show(), $("#no-account-aff").show(), $("#invest_btn").attr("data-target", "#unlock-metamask"), $("#invest_withdraw").attr("data-target", "#unlock-metamask"), $("#invest_withdraw").attr("data-toggle", "modal"), d()) : ($("#no-mainnet").show(), $("#no-mainnet-aff").show(), $("#invest_btn").attr("data-target", "#switch-metamask-to-mainnet"), $("#invest_withdraw").attr("data-target", "#switch-metamask-to-mainnet"), $("#invest_withdraw").attr("data-toggle", "modal"), d()) : ($("#no-metamask").show(), $("#no-metamask-aff").show(), $("#invest_btn").attr("data-target", "#why-use-metamask"), $("#invest_withdraw").attr("data-target", "#why-use-metamask"), $("#invest_withdraw").attr("data-toggle", "modal"), d()), $("#f_investments").on("click", function(e) {
        if (!o || !s || !i) return 0;
